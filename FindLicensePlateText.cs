...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            // await Send("queuePlateForManualCheckup", "TollBooth/CustomerService", data);var uriBase = Environment.GetEnvironmentVariable("computerVisionApiUrl");
            // var apiKey = Environment.GetEnvironmentVariable("computerVisionApiKey");TODO 2: Populate the below two variables with the correct AppSettings properties.
